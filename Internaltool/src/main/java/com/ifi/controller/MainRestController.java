...
//			request_form.setStatus(0);//mặc định là 0: chờ được duyệt
	...
	public @ResponseBody Payload deleteForm() {
		...
		Object data = "";
		try {
			UUID emp_id = UUID.fromString("9cc09-47fa-4a3c-b651-db5469d782e3");
//			UUID pro_id = UUID.fromString("f2b4e014-e51c-48ed-b28f-823f1f911ea9");
//			UUID request_id = UUID.fromString("f8ab198c-460e-4aaf-93a6-8ea33f68e9df");
			Request_form f=(Request_form) appService.getAllRequestByEmpid(emp_id);
			appService.deleteRequest(f);
			message.setCode("Success code");
			message.setStatus("OK");
